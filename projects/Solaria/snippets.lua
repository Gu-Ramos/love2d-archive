local function build_shader(taps, offset, offset_type, sigma) -- Fast gaussian blur shader from moonshine
...
function updateScaling(wx,wy) -- Scale
  ...
  Scale = 16/9*wx > wy and wy/1080 or wx/1920
  TranslateX, TranslateY = wx/2-1920*sc/2, wy/2-1080*sc/2
  
  Transform = love.math.newTransform(TranslateX,TranslateY, 0, Scale,Scale, 0,0)
  
  RealX0, RealY0 = Transform:inverseTransformPoint(0,0)
  RealX1, RealY1 = Transform:inverseTransformPoint(wx,wy)
end
