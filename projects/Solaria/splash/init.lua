...
function splashlib.new(init)
  ...
  local handyfont = love.graphics.newFont(current_folder .. "/handy-andy.otf", 22)
  handyfont:setFilter('nearest','nearest')
  self.text = {
    obj   = love.graphics.newText(handyfont, "made with"),
    alpha = 0
  }
...
function splashlib:draw()
  ...
  self.canvas:renderTo(function()
    ...
    love.graphics.rectangle(
      "fill",
      self.stripes.offset - width, -self.stripes.height*1.5,
      width * 2, self.stripes.height*1.6
    )
