...
function flux:update(deltatime)
  for i = #self, 1, -1 do
    ...
    if t._delay > 0 then
      ...
      if t._onupdate then t._onupdate(t) end
      if p >= 1 then
        if t._rewind and (t._rewind == true or t._rewind > 1) then
          ...
          if t._onrewindcomplete then t._onrewindcomplete(t) end
        elseif t._cycle and (t._cycle == true or t._cycle > 1) then
          t.progress = 0
          t._cycle = (t._cycle == true) or (t._cycle - 1)
          if t._oncyclecomplete then t._oncyclecomplete(t) end
        else
          flux.remove(self, i)
          if t._oncomplete then t._oncomplete(t) end
        end
      end
    end
  end
