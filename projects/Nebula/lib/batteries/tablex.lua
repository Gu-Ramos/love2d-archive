...
function tablex.merge_inplace(t1, t2, replace)
	if replace then
...
function tablex.merge(t1, t2, replace)
	local r = {}
	tablex.merge_inplace(r,t1)
	tablex.merge_inplace(r,t2,replace)
	return r
end
