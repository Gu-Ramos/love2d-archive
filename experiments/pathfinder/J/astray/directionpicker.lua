...
--	print('DirectionPicker:PickDifferentDirection')
	...
	local directionPicked = love.math.random(0,3)
	while (directionPicked == self.previousDirection) and (#self.directionsPicked < 3) do
		directionPicked = love.math.random(0,3)
	end
...
--	print('DirectionPicker:MustChangeDirection count=', #self.directionsPicked, ' or=',self.changeDirectionModifier > love.math.random(0, 99))
	return ((#self.directionsPicked > 0) or (self.changeDirectionModifier > love.math.random(0, 99)))
end
